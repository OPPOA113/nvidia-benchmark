...
ICudaEngine* createEngine(unsigned int maxBatchSize, IBuilder* builder, IBuilderConfig* config, DataType dt) {
    ...
    std::map<std::string, Weights> weightMap = loadWeights("../mobilenet0.25_retinaface.wts");
    Weights emptywts{DataType::kFLOAT, nullptr, 0};
    ...
    Int8EntropyCalibrator2 *calibrator = new Int8EntropyCalibrator2(1, INPUT_W, INPUT_H, "/workspace/dataset/benchmarch_data/widerface/val/calib/", "mnet_int8calib.table", INPUT_BLOB_NAME);
