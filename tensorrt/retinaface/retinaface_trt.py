...
INPUT_H = 320#480  #defined in decode.h
INPUT_W = 320#640
CONF_THRESH = 0.75
IOU_THRESHOLD = 0.4
...
class Retinaface_trt(object):
    ...
    def __init__(self, engine_file_path):
        ...
        for binding in engine:
            print("idx:",idx,"-binding:",binding)
            print("shape:",engine.get_binding_shape(binding),",max_batchsize:",engine.max_batch_size)
...
if __name__ == "__main__":
    ...
    # engine_file_path = "/workspace/project/projects/Pytorch_Retinaface/weights_engine/resnet50_1_320_retinaface_int8.engine"

    retinaface = Retinaface_trt(engine_file_path)
    input_image_paths = ["test.jpg","worlds-largest-selfie.jpg"]
    for i in range(10):
